...
import com.nusantara.bajuadatapp.navigation.NavigationItem
...
@Composable
fun BajuAdatApp(
    k_Bajuadat : List<K_BajuAdat>,
    b_BajuAdat : List<B_BajuAdat>,
...
@Composable
private fun BajuAdatAppPrev() {
    BajuAdatApp(
        k_Bajuadat = DummyData.mobileKbajuAdat,
        b_BajuAdat = DummyData.mobileBBajuAdat,
    )
}